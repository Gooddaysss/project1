		...
		<form action="messageSend">
			...
			<table class="table table-hover">
				<tbody>
					...
					<tr>
						<td>
							<textarea type="text" class="form-control" placeholder="쪽지 내용을 작성하세요" name="mcontent" maxlength="1024" style="resize: none; height: 400px;"></textarea>
						</td>
					</tr>
				</tbody>
			...
			<div style="margin: 12px;">
				...
				<button style="margin:2px; float:right;" type="submit" class="btn btn-primary">쪽지 보내기</button>
