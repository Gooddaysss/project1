...
<form>
		<div class="container">
			...
			<div style="margin: 12px;">
				<a style="margin:2px; float:right;" class="btn btn-primary" href="messageForm?rno=<c:out value="${messageInfo.sno}" />">답장하기</a>
						<a style=" margin:2px; float:right; font-color:white" href="#" onclick="history.back(-1)" class="btn btn-primary">쪽지목록</a> 
			</div>
