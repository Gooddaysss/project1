		...
		<c:when test="${sessionScope.roletype == 'USER' && count == 0}">
			<div class="container">
				...
				<h1>후기</h1>
					...
					<div class="review_contents" style="margin: 12px;">
            			<textarea style="resize: none; height: 150px;" placeholder="5자 이상으로 작성해 주세요." name="rcontent" rows="10" class="review_textarea"></textarea>
            			...
            			<br>
            			<a class="btn btn-primary" style="margin:2px;" href="adminRead?userno=${userInfo.userno }" onclick="form8.submit()">저장</a>
        			</div>   
